...
var _ = g.Describe("[OTP][sig-openshift-logging] Logging NonPreRelease Forward to GCL", func() {
	defer g.GinkgoRecover()
	var (
		oc             = compat_otp.NewCLI("vector-to-google-cloud-logging", compat_otp.KubeConfigPath())
