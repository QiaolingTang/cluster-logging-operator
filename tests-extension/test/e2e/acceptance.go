...
var _ = g.Describe("[OTP][sig-openshift-logging] LOGGING Logging", func() {
...
retry_max_duration_secs = 20`,
	...
	g.It("Author:kbharti-CPaasrunBoth-Critical-85642-Deploy LokiOperator with network policies enabled[Slow][Serial]", func() {
