...
var _ = g.Describe("[OTP][sig-openshift-logging] Logging NonPreRelease loki-operator - Managed auth/STS mode", func() {
	defer g.GinkgoRecover()

	var (
		oc                    = compat_otp.NewCLI("loki-sts-wif-support", compat_otp.KubeConfigPath())
